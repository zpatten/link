...
function set_link_logistics_provided(json)
...
function set_link_logistics_requested(json)
...
function set_link_logistics_fulfilled(json)
...
function set_link_logistics_unfulfilled(json)
...
function set_link_logistics_overflow(json)
