...
Link::Support::Metrics.guage(:electrical_count)
Link::Support::Metrics.guage(:electrical_delta_count)
Link::Support::Metrics.guage(:server_rtt)
Link::Support::Metrics.guage(:storage_delta_count)
Link::Support::Metrics.guage(:storage_item_count)
Link::Support::Metrics.guage(:thread_count)
Link::Support::Metrics.guage(:thread_timing)
# Link::Support::Metrics.histogram(:thread_execution)
